...
| :----: | :--- |
| &nbsp;⚠️ <br> Empty ToS -page&nbsp; | Does the registration form (page) include GDPR-compliant consent for processing<br> personal data (e.g., acceptance of the privacy policy)?|
| &nbsp;⚠️ <br> Only view&nbsp; | Can users view, edit, and delete their own personal data via their account? |
...
| &nbsp;⚠️ <br> Username (email) shown in DB&nbsp; | Is it ensured that names, emails, or other personal data of bookers are not exposed<br> publicly or to unauthorized users? |
...
| &nbsp;⚠️ <br> depends: locally stored&nbsp; | Is personal data stored in data centers located within the EU? |
...
| :----: | :--- |
| &nbsp;⚠️ <br> empty page &nbsp; | Is there a privacy policy available to users during registration and easily accessible? |
